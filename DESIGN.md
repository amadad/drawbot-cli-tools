...
- Input model: recipe + content fixture
...
rules:
  ...
  - content must provide quote, author, and source fields
...
The recipe should map these tokens onto the current `drawbot spec` surface as directly as possible. The content fixture shows the minimum authoring input an agent must provide. The review rubric gives a concrete success check for human or automated review.
